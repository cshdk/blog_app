...
?>
 <nav class="large-3 medium-4 columns" id="actions-sidebar">
    ...
    <div class="side-nav_view">
     <div class="side-nav">
         <div class="new_tweet_button_view"><?= $this->Form->postLink(__('Delete Tweet'), ['action' => 'delete', $tweet->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tweet->id)]) ?></div>
         </div>
         <div class="side-nav">
           <div class="new_tweet_button_view"><?= $this->Html->link(__('New Tweet'), ['action' => 'add']) ?></div>
         </div>
         <div class="side-nav">
           <div class="new_tweet_button_view"><?= $this->Html->link(__('Edit Tweet'), ['action' => 'edit', $tweet->id]) ?></div>
         </div>
        <div class="nul_box">
        </div>
     </div>
